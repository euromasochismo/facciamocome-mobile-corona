...
local function deleteTableResults()
	-- SVUOTA E NASCONDE L'EVENTUALE TABLEVIEW (DEVO CHIAMARLA 2 VOLTE NON SO PERCHE'!)
	if (tableResults~=nil) then 
		-- print("\n\nEXISTS!")
		tableResults:deleteAllRows()
		tableResults.isVisible = false
	end
end
